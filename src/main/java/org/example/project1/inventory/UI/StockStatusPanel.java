...
public class StockStatusPanel extends JPanel {
    ...
    public ProductInfoProductVO getSelectedProduct() {
        ...
        if (selectedRow != -1) {
            return new ProductInfoProductVO((String) tableModel.getValueAt(selectedRow, 0), Integer.parseInt(tableModel.getValueAt(selectedRow, 1).toString()), (String) tableModel.getValueAt(selectedRow, 2), (String) tableModel.getValueAt(selectedRow, 3), Integer.parseInt(tableModel.getValueAt(selectedRow, 5).toString()), Integer.parseInt(tableModel.getValueAt(selectedRow, 7).toString()), Integer.parseInt(tableModel.getValueAt(selectedRow, 8).toString()), (String) tableModel.getValueAt(selectedRow, 9));
        }
        return null;
    }
